...
def test_private_runner_workflow_is_manual_only_and_schedule_is_inert() -> None:
    ...
    assert "inputs.activate_private_runner == true || github.event_name == 'schedule'" in text
    assert "always() && (inputs.activate_private_runner == true || github.event_name == 'schedule')" in text
